...
Function SetPaintNetAsDefaultEditor {
    ...
    Set-ItemProperty -Path "HKCR:\SystemFileAssociations\image\shell\edit\command" -name '(Default)' -Value "C:\Program Files\Paint.NET\PaintDotNet.exe"
}
...
Function SetPaintAsDefaultEditor {
    ...
    Set-ItemProperty -Path "HKCR:\SystemFileAssociations\image\shell\edit\command" -name '(Default)' -Value "%systemroot%\system32\mspaint.exe"
}
